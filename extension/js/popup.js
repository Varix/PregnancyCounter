...
// - バッジをウィーク表示とカウントダウン表示で切り替えられるようにしたい。
// - 複数のChromeで出産予定日の設定値を同期するようにしたい。
/////////////////////////////////
// # TODO 完了済
// - 妊娠月週日を表示するようにしたい。
...
// - jQueryで動的にプルダウン内の項目<option>を生成するようにしたい。
...
var controlDay = function(){
	...
	if($("#inputMM").val() == 2){
		...
		// うるう年の判定方法参考：http://support.microsoft.com/kb/214019/ja
